...
public class OAuthService {
    ...
    public ResponseEntity<String> createGetRequest(OAuthTokenDto oAuthToken, String providerId) {
    ...
    public GoogleUserDto getGoogleUserInfo(ResponseEntity<String> userInfoResponse) {
        GoogleUserDto googleUser = null;
        try {
            googleUser = objectMapper.readValue(userInfoResponse.getBody(), GoogleUserDto.class);
        } catch (JsonProcessingException e) {
            e.printStackTrace();
        }
        return googleUser;
    ...
    public NaverUserDto getNaverUserInfo(ResponseEntity<String> userInfoResponse) {
        ...
        try {
            ...
            log.info(request);
            naverUser = objectMapper.readValue(request, NaverUserDto.class);
        } catch (JsonProcessingException e) {
            e.printStackTrace();
        }
        return naverUser;
